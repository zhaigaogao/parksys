...
@Controller
@RequestMapping("ExportGarageHistory")
public class ExportGarageHistoryController extends BaseController{
	/**
	 * 导出历史表信息生成excel表格
	 */
	@Autowired
	...
	@RequestMapping("/exportGarageHistoryList")
	@ResponseBody
	public void exportExcel(HttpServletResponse response,HttpServletRequest request){
		...
		HSSFCell cell = row.createCell(++i);
			...
			List<GarageHistory> garageHistories=garageHistoryService.SelectGarageHistoryList(garageHistory);
			//将数据和抬头一一对应
	    Map<String,Object> vmap = new HashMap<String,Object>();
	    Map<String,Integer> imap = new HashMap<String,Integer>();
		for (GarageHistory map : garageHistories) {
			i=-1;
